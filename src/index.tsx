...
export const Users = () => {
  ...
  const sortHandler = (sortBy: string) => {
    // ❗❗❗ XXX ❗❗❗
      setActiveColumn(activeColumn.sortDirection === "asc" ? {sortBy, sortDirection: "desc"} : {sortBy, sortDirection: "asc"})
  };
...
// Неверный ответ: setActiveColumn({sortBy, sortDirection: "asc"})
// Неверный ответ: activeColumn.sortDirection === "asc" ? setActiveColumn({sortBy, sortDirection: "desc"}) : setActiveColumn({sortBy, sortDirection: "asc"})
// Попробовать ответ: setActiveColumn(activeColumn.sortDirection === "asc" ? {sortBy, sortDirection: "desc"} : {sortBy, sortDirection: "asc"})