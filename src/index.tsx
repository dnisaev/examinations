...
// Неверный ответ: setActiveColumn(activeColumn.sortDirection === "asc" ? {sortBy, sortDirection: "desc"} : {sortBy, sortDirection: "asc"})
// Попробовать ответ: setActiveColumn({sortBy, sortDirection: activeColumn.sortDirection === "asc" ? "desc" : "asc" })